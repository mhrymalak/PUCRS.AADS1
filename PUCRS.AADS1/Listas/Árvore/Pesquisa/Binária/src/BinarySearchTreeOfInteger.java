...
public class BinarySearchTreeOfInteger
{
    ...
    {   if(n ==  null)
        ...
        if (e < n.element)      n.left  = add(n.left, e, n);
        else if (e > n.element) n.right = add(n.right, e, n);
    ...
    {   if (root == null || element == null)
        ...
        if (aux == null)    // se não achou o elemento
            return false;
        remove(aux);
        count--;
        return true;
    ...
    {   if(n.left == null && n.right == null)
        {     if(n.father == null)  root = null;
              else if(n.father.right.element.equals(n.element))n.father.right = null;
              else n.father.left  = null;
        }
        else if(n.left  == null)
